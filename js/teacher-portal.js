    ...
    container.innerHTML = `
      ...
      <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
        <form onsubmit="TeacherPortal.schedule(event)" class="lg:col-span-2 glass-card rounded-2xl p-5 border border-slate-800 space-y-4">
          ...
          <div><label class="block text-xs font-semibold text-slate-300 mb-1">Disciplina</label><select id="teacher-discipline" class="w-full px-3 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-white text-sm"><option value="defensa-personal">Defensa Personal</option><option value="boxeo">Boxeo</option><option value="taekwondo">Taekwondo</option><option value="hapkido">Hapkido</option></select></div>
